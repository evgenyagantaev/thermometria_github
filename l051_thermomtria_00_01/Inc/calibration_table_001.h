...
double H[DATA_LENGTH] = {0,0,5,17,0,17,5,18,0,15,17,12,15,17,7,5,
	    		0,0,16,16,0,13,15,15,0,16,14,15,16,11,15,0,0,0};  // flat high temperature correction
/*
...
double Q[DATA_LENGTH] = {0,0,0.0107,0.0100,0,0.0100,0.0027,0.0107,0,0.0080,0.0073,0.0060,0.0073,0.0060,0.0053,0.0073,
			    0,0,0.0040,0.0067,0,0.0080,0.0053,0.0080,0,0.0100,0.0060,0.0027,0.0047,0.0047,0.0067,0,0,0.0287};  // edge low temperature correction
double T0 = 1000.0;
...
double K[(DATA_LENGTH-2)/2] = {1,1,159,148,1,155,116,149,1,125,161,155,155,145,150,128};  // flux coefficient
double J[(DATA_LENGTH-2)/2] = {0,0,-200,200,0,0,0,0,0,0,400,0,0,-100,-200,0};  // flux offset
