...
*/
double L[DATA_LENGTH] = {0,0,0.0107,0.0100,0,0.0100,0.0027,0.0107,0,0.0080,0.0073,0.0060,0.0073,0.0060,0.0053,0.0073,
			    0,0,0.0040,0.0067,0,0.0080,0.0053,0.0080,0,0.0100,0.0060,0.0027,0.0047,0.0047,0.0067,0,0,0};  // edge low temperature correction
double T0 = 1000.0;
